            ...
            <div class="collapse navbar-collapse" id="navbarMain">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link" href="${pageContext.request.contextPath}/about_us.jsp" id="navbarDropdown" >GIỚI THIỆU</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" href="artwork">TÁC PHẨM</a></li>
                    <li class="nav-item"><a class="nav-link" href="${pageContext.request.contextPath}/discount">CHƯƠNG TRÌNH GIẢM GIÁ</a></li>
                    <li class="nav-item dropdown">
